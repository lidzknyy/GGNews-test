...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    private static final String SQL_CREATE_ENTRIES =
            ...
            NewsContract.NewsEntry.COLUMN_NAME_IMAGE + " INT " + " )";
    ...
    private void initDb(SQLiteDatabase sqLiteDatabase){
        ...
        for(int i = 0; i < length; i++){
            ...
            Log.e("MySQLiteOpenHelper", images.getString(i));
//            values.put(NewsContract.NewsEntry.COLUMN_NAME_IMAGE, images.getString(i));
            values.put(NewsContract.NewsEntry.COLUMN_NAME_IMAGE, images.getResourceId(i,0));
